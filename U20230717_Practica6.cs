...
namespace MyApp// Note: actual namespace depends on the project name.\
{
    internal class Program
    {
        ...
        {
            //Variable boleana para poder hacer el ciclo con las opciones
            bool salir = false;
            ...
            do
            {
                ...
                switch (opcion)
                {
                    ...
                    if (int.TryParse(Console.ReadLine(), out int n) && n > 0)
                    {
                        ...
                        Console.WriteLine("\nLa suma de los numeros impares en el rango es: " + sumaImpares);
                    }
                ...
                case "3":
                    ...
                    //Utilizamos un bucle for para multiplicar la tabla de multiplicar del numero ingresado
                    for (int i = 1; i <= 10; i++)  
                    {
